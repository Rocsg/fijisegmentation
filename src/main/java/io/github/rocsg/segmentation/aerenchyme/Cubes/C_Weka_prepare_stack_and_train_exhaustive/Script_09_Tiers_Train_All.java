...
public class Script_09_Tiers_Train_All {
    private static final String BASE_PATH         = "/Donnees/DD_CIRS626_DATA/Data_Cube_HTP";
    private static final String RAW_TRAIN_PATH    = BASE_PATH + "/RawAll.tif";
    private static final String EXGAINE_TRAIN     = BASE_PATH + "/gaineAll.tif";
    private static final String EXLACUNA_TRAIN    = BASE_PATH + "/lacunaAll.tif";
    private static final String MODEL_GAINE_PATH  = BASE_PATH + "/trained_gaine_all.model";
    private static final String MODEL_LACUNA_PATH = BASE_PATH + "/trained_lacuna_all.model";

    private static final int RANDOM_SEED  = 42;
    private static final int DIVIDE       = 5;
    private static final int N_EXAMPLES   = 50000;
